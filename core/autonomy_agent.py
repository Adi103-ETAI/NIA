...
class AutonomyAgent:
    ...
    def _generate_context_aware_suggestion(self) -> Optional[AutonomousSuggestion]:
        ...
        suggestion_text = self._generate_suggestion_for_context(topic, trigger_type)
        ...
        return AutonomousSuggestion(
            ...
            topic=topic,
            timestamp=time.time(),
            metadata={"source": "context_aware_autonomy"}
        )
    ...
    def _generate_suggestion_for_context(self, topic: Optional[str], trigger_type: str) -> Optional[str]:
        """Generate appropriate suggestion text based on context."""
        suggestions = {
            "decision_keyword": [
                "I can help you think through that decision. What factors are you considering?",
                "Would you like me to help you weigh the pros and cons?",
                "I'm here to help you work through this. What's your main concern?"
            ],
            "high_value_topic": [
                f"I noticed you mentioned {topic}. Would you like some help with that?",
                f"Regarding {topic}, I might have some useful insights. Interested?",
                f"I can help you with {topic} if you'd like some assistance."
            ],
            "hesitation": [
                "It sounds like you're thinking through something. Want to talk it out?",
                "I'm here if you need help sorting through your thoughts.",
                "Would it help to discuss what's on your mind?"
            ],
            "repetition": [
                "I notice you've mentioned this before. Would you like some help with it?",
                "It seems like this is important to you. How can I help?",
                "Would you like to work through this together?"
            ],
            "periodic": [
        ...
        topic_suggestions = suggestions.get(trigger_type, suggestions["periodic"])
        # Rotate through suggestions based on time
        idx = int(time.time() // 60) % len(topic_suggestions)
